                                        ...
                                        <div class="col-xs-12 col-sm-7 col-md-6">
                                            <div class="post-center-content">
                                                ...
                                                <div class="actions">
                                                    <ul>
                                                        <li>
                                                            <a href="{{route('addtocart',['id'=>$data->id])}}" target="_blank" data-toggle="blog-tags" data-placement="top" title="" data-original-title="Add To Cart">
                                                                <i class="fa fa-shopping-cart"></i>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="{{route('product',['id'=>$data->id,'slug'=>$data->slug])}}" data-toggle="blog-tags" data-placement="top" title="" data-original-title="Like">
